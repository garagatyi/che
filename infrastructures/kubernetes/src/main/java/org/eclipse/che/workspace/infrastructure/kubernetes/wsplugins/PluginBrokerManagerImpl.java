 ...
 */
@Beta
public class PluginBrokerManagerImpl<E extends KubernetesEnvironment> implements
    PluginBrokerManager<E> {

  private static final Logger LOG = LoggerFactory.getLogger(PluginBrokerManagerImpl.class);
  ...
  @Inject
  public PluginBrokerManagerImpl(
