...
/**
 * Applies {@link ChePlugin} objects configuration to a kubernetes internal runtime object.
 *
 * @author Oleksander Garagatyi
 */
@Beta
public class KubernetesChePluginsApplier implements ChePluginsApplier {

  private final String defaultMachineMemorySizeAttribute;

  @Inject
  public KubernetesChePluginsApplier(
