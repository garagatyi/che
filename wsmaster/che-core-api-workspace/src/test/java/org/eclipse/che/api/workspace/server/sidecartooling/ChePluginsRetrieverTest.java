...
import org.eclipse.che.api.workspace.server.sidecartooling.model.CheFeatureSpec;
...
import org.eclipse.che.api.workspace.server.sidecartooling.model.ObjectMeta;
import org.eclipse.che.api.workspace.server.sidecartooling.model.Volume;
...
public class ChePluginsRetrieverTest {
  ...
  ChePluginsRetriever retriever;

  @BeforeMethod
  public void setUp() throws Exception {
    retriever = spy(new ChePluginsRetriever(API_ENDPOINT));
  }

  @Test
  public void doesNothingWhenFeatureApiIsNotSet() throws Exception {
    retriever = new ChePluginsRetriever(null);
  ...
  @Test(
    expectedExceptions = InfrastructureException.class,
    expectedExceptionsMessageRegExp = "Invalid Che plugins configuration: feature .* is duplicated"
  )
